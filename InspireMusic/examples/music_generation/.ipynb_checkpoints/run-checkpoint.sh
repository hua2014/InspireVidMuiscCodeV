...
dataset_name=BD-ESV-260106_normal_caption 
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  expr_name="InspireMusic-1.5b-long-BD-ESV-260106_normal_caption-s2-ft260113-1"
  ...
  torchrun --nnodes=1 --nproc_per_node=$num_gpus \
      ...
      --checkpoint ./exp/InspireMusic-1.5b-long-BD-ESV-260106_normal_caption-s1-ft260112-1/llm/deepspeed/epoch_4_whole/mp_rank_00_model_states.pt
  ...
  #     --deepspeed_config ./conf/ds_stage2.json \
  #     --deepspeed.save_states model+optimizer
  # nohup sh run.sh > ./InspireMusic-1.5b-long-BD-ESV-251222_default_caption-s2-ft260103-3.log 2>&1 &
  # --checkpoint ../../pretrained_models/InspireMusic-1.5B-Long/llm.pt
  # --checkpoint ../../pretrained_models/InspireMusic-1.5b-long-BD-ESV-260106_default_caption-s1-ft251230-3/mp_rank_00_model_states.pt
  # python zero_to_fp32.py ./ /root/autodl-tmp/InspireVidMuisc/InspireMusic/pretrained_models/InspireMusic-1.5b-long-BD-ESV-260106_normal_caption-s1-ft260106-1 --max_shard_size "10GB"
fi
