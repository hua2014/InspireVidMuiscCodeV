...
class LMModel(StreamingModule):
    ...
    def __init__(self, pattern_provider: CodebooksPatternProvider, condition_provider: ConditioningProvider, 
        ...
        if self.visual_encoder == 'clip':
            self.visual_encoder_model = CLIPVisionModelWithProjection.from_pretrained("/root/autodl-tmp/InspireVidMuisc/VidMuse-main/pretrained_model/openai_clip-vit-base-patch32")
            self.processor = AutoProcessor.from_pretrained("/root/autodl-tmp/InspireVidMuisc/VidMuse-main/pretrained_model/openai_clip-vit-base-patch32")
